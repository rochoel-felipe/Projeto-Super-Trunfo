...
int main()
{
    ...
    int variavel_salvadora = 0;

    while (variavel_salvadora == 0)
    {
        ...
        case 5:
            ...
            if (cartas == NULL)
            {
                ...
                free(cartas); // Libere a memória antiga
                fclose(fp);
                return 1; // Encerre o programa para evitar problemas
            } // if

            break;
        case 6:
            printf("Saindo do código.\n");
            variavel_salvadora++;
            break;
        default:
